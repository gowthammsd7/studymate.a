...
export default function StudyGroups() {
  ...
  const [studyGroups, setStudyGroups] = useState<StudyGroup[]>([
    {
      ...
      description:
        "Weekly sessions focusing on calculus concepts, problem-solving, and exam preparation. All skill levels welcome!",
      subject: "Mathematics",
      type: "study-session",
      privacy: "public",
      memberCount: 8,
    ...
    },
    {
      ...
      description:
        "Collaborative problem-solving sessions for physics courses. Share solutions and learn together.",
      subject: "Physics",
      type: "discussion",
      privacy: "public",
      memberCount: 15,
    ...
    },
    {
      ...
      description:
        "Intensive study group for organic chemistry. Focus on reaction mechanisms and synthesis.",
      subject: "Chemistry",
      type: "exam-prep",
      privacy: "private",
      memberCount: 6,
    ...
    },
    {
      ...
      description:
        "Peer review and discussion group for history essays and research papers.",
      subject: "History",
      type: "project-group",
      privacy: "public",
      memberCount: 12,
  ...
  const recommendedGroups = studyGroups
    .filter((group) => !group.isJoined && group.privacy === "public")
    .slice(0, 3);
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Join collaborative study sessions and connect with peers
                </p>
              </div>
            </div>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          <Badge className="capitalize">
                            {React.createElement(getTypeIcon(group.type), {
                    ...
                    <div className="space-y-4">
                      ...
                      {group.nextSession && (
                        <div className="flex items-center space-x-2 text-sm text-gray-600">
                          ...
                          <span>
                            Next: {group.nextSession.toLocaleDateString()} at{" "}
                        ...
                        {group.nextSession && (
                          <div className="p-3 bg-blue-50 rounded-lg">
                            ...
                            <p className="text-sm text-blue-700">
                              {group.nextSession.toLocaleDateString()} at{" "}
                              {group.nextSession.toLocaleTimeString([], {
                                hour: "2-digit",
                                minute: "2-digit",
                              })}
              ...
              <Card className="bg-white/70 backdrop-blur-sm border-white/20">
                <CardContent className="pt-8 pb-8 text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    Browse and join study groups to start collaborating with
                    peers
                  </p>
                  <Button>
          ...
          <TabsContent value="recommended" className="space-y-6">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-sm mb-4">
                      Based on your study patterns and subjects, here are some
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {recommendedGroups.map((group) => (
                <Card
                  key={group.id}
                  className="bg-white/70 backdrop-blur-sm border-white/20 relative"
                >
