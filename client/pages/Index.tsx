  ...
  const features = [
    {
      ...
      title: "AI Advisor",
      description:
        "Get personalized study recommendations powered by advanced AI",
      href: "/ai-advisor",
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
              ...
              recommendations, instant homework help, and intelligent study
              tools designed to maximize your academic success.
            </p>
