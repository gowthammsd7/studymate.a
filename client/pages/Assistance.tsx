  ...
  const [conversations, setConversations] = useState<Conversation[]>([
    {
      ...
      messages: [
        ...
        },
        {
          ...
          type: "user",
          content:
            "Yes, can you show me how to find the derivative of sin(x²)?",
      ...
      messages: [
        {
          ...
          type: "user",
          content:
            "I'm struggling with Newton's second law problems. Can you help?",
        ...
        },
        {
          ...
          type: "user",
          content:
            "Yes! A 10 kg box is being pushed across a floor with a force of 50 N. If the coefficient of friction is 0.3, what's the acceleration?",
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Get instant help with homework, concepts, and study strategies
                </p>
              </div>
            </div>
                ...
                <div className="flex-1 flex items-center justify-center p-8">
                  <div className="text-center max-w-2xl">
                    ...
                    <p className="text-gray-600 mb-8">
                      I'm here to help you with homework, explain concepts, and
                      provide study strategies. Choose a quick action below or
                      ...
                      <div className="p-4 space-y-4">
                        {currentConversation?.messages.map((message) => (
                          ...
                          >
                            ...
                            <div
                              className={`max-w-[80%] ${message.type === "user" ? "order-2" : ""}`}
                            >
                              <div
