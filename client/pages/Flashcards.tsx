...
export default function Flashcards() {
  ...
  const [studyMode, setStudyMode] = useState<"study" | "create" | "browse">(
    "browse",
  );
  ...
  const filteredSets = flashcardSets.filter((set) => {
    ...
    const matchesSubject =
      selectedSubject === "" || set.subject === selectedSubject;
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center space-x-4">
                <Button variant="ghost" onClick={() => setStudyMode("browse")}>
              ...
              <DialogContent>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Select
                      onValueChange={(value) =>
                        setNewSet((prev) => ({ ...prev, subject: value }))
                      }
                    >
                      <SelectTrigger>
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <p className="font-medium">
                            {formatStudyTime(set.totalStudyTime)}
                          </p>
                        </div>
                        <div>
          ...
          <TabsContent value="statistics" className="space-y-6">
              ...
              <Card className="bg-white/70 backdrop-blur-sm border-white/20">
                <CardContent className="pt-6">
                  ...
                  <p className="text-2xl font-bold text-gray-900 mt-2">
                    {formatStudyTime(
                      flashcardSets.reduce(
                        (total, set) => total + set.totalStudyTime,
                        0,
                      ),
                    )}
                  </p>
            ...
            <Card className="bg-white/70 backdrop-blur-sm border-white/20">
              ...
              <CardContent>
                <div className="space-y-4">
                  {subjects.map((subject) => {
                    const subjectSets = flashcardSets.filter(
                      (set) => set.subject === subject,
                    );
                    const totalCards = subjectSets.reduce(
                      (total, set) => total + set.cards.length,
                      0,
                    );
                    const avgMastery =
                    ...
                    return (
                      ...
                      >
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            {subjectSets.length} sets • {totalCards} cards
                          </p>
                        </div>
